...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    public static double kV = 0.01215; // rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = 5.468408160113869;
    public static double MAX_ANG_ACCEL = 4.022789714171758;
